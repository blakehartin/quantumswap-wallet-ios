...
public extension UIColor {
    ...
    static var quantumTeal: UIColor { named("quantumTeal", fallback: 0x14B8A6) }
    static var quantumGreen: UIColor { named("quantumGreen", fallback: 0x34D399) }
    static var quantumPanel: UIColor { named("quantumPanel", fallback: 0x0B0B12) }
}
