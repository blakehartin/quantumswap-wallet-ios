...
// Android reference:
// app/src/main/java/com/quantumswap/app/view/fragment/HomeWalletFragment.java
...
public final class HomeWalletViewController: UIViewController, HomeScreenViewTypeProviding {
    ...
    private func renderSetPassword() {
        ...
        // Password as QuantumSwap-<deviceSuffix>?". Saving is
...
// short-term mitigation. The
    ...
    /// On the post-onboarding "Create or Restore QuantumSwap Wallet" entry
