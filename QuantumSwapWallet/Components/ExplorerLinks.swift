...
public enum ExplorerLinks {
    ...
    public static func makeValueLabel(_ value: String, url: URL?, mono: Bool,
                                      size: CGFloat = 12, color: UIColor = UIColor(rgbHex: 0xE0E0E6)) -> UIView {
        let tv = UITextView()
        tv.isEditable = false
        ...
        if let url {
            let attrs: [NSAttributedString.Key: Any] = [
                .font: font, .foregroundColor: UIColor.quantumTeal,
                .underlineStyle: NSUnderlineStyle.single.rawValue,
                .link: url
            ]
            tv.attributedText = NSAttributedString(string: value, attributes: attrs)
            tv.linkTextAttributes = [.foregroundColor: UIColor.quantumTeal,
                                     .underlineStyle: NSUnderlineStyle.single.rawValue]
    ...
    public static func makePairLabel(symA: String, tokenA: String, symB: String, tokenB: String,
        ...
        s.append(NSAttributedString(string: " / ",
            attributes: [.font: font, .foregroundColor: UIColor(named: "colorCommon6") ?? .white]))
    ...
    private static func appendToken(_ s: NSMutableAttributedString, _ label: String,
        ...
        var attrs: [NSAttributedString.Key: Any] = [.font: font, .foregroundColor: UIColor.quantumTeal]
