...
public final class GasConfigDialogViewController: ModalDialogViewController {
    ...
    public override func viewDidLoad() {
        ...
        let limitLabel = DexScreenChrome.makeHeading(L.lang("gas-limit", fallback: "Gas limit (gas-units)"))
        ...
        limitField.backgroundColor = UIColor(argbHex: 0x14FFFFFF)
        ...
        let feeLabel = DexScreenChrome.makeHeading(L.lang("gas-fee", fallback: "Estimated gas fee (coins)"))
